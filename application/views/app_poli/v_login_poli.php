        ...
        <div class="login-area">
            <div class="container">
                <div class="login-box ptb--100">
                    ...
                    <form action="<?php echo base_url() . 'C_login/login_poli'; ?>" method="post">
                        <div class="login-form-head">
                        <div class="logo">
                            <a href="index.html">
                            <img src="<?php echo base_url()?>assets/images/icon/logoklnk.png" alt="logo"></a>
                        </div>
                            <h4>Login Poli</h4>
                            <p>Silahkan login untuk mengakses ini!</p>
                        </div>                        
