...
class M_rekammedis extends CI_Model {
    ...
    public function v_rekammedis($id_poli) {  
        return $this->db->query("SELECT a.id_pendaftaran, a.keluhan, "
        . "b.nama AS pasien, b.alamat, b.status, b.nis_nik, c.no_rm, c.diagnosa, c.tindakan, c.terapy, c.perawat, d.nama_dokter, e.nama AS poli FROM "
 ...
 public function detail2($id_rm) {
    return $this->db->query("SELECT a.id_pendaftaran, a.tgl_daftar, a.jam_daftar, a.keluhan, a.no_antrian, "
            . "b.nama AS pasien, b.alamat, b.status, b.kelamin, b.daerah, c.nama AS poli, d.nama_dokter, e.no_rm, e.diagnosa, e.tindakan, e.terapy FROM "
