...
class M_laporan_rm extends CI_Model {
    ...
    public function semua_data() {
        ...
        return $this->db->query("SELECT a.id_pendaftaran, a.tgl_daftar, a.jam_daftar, a.keluhan, a.no_antrian, "
                . "b.nama AS pasien, b.alamat, b.usia, b.kelamin, b.status, b.nis_nik, c.nama AS poli, d.nama_dokter, e.no_rm, e.diagnosa, e.tindakan, e.terapy, e.perawat FROM "
    ...
    public function tampil($id_poli) {
        ...
        return $this->db->query("SELECT a.id_pendaftaran, a.tgl_daftar, a.keluhan, "
                . "b.nama AS pasien, b.alamat, b.status, b.nis_nik, c.nama AS poli, d.nama_dokter, e.no_rm, e.diagnosa, e.tindakan, e.terapy, e.perawat FROM "
